...
public class AlertTest {
    ...
    public void alertTest() {
        ...
        String randomString = StringGenerator.getAlphaNumericString();
        mainPage.typeRandomTextInPrompt(randomString);
        mainPage.AcceptAlert();
        Assert.assertEquals(mainPage.getResultText(), TestData.getPromptAlertResultText(randomString));
    }
